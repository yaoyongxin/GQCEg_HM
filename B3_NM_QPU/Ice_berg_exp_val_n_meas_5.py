...
model = QiskitCircuitGeneratorAVQITE(ansatz_filename='ansatz_inp_100.pkle', incar_filename='incar_12')
...
for s in [1.0]: 
    ...
    P_str=['IIIIIIIIIIII','ZIIIIIIIIIII','YZYIIIIIIIII','XZXIIIIIIIII','YZZZYIIIIIII','XZZZXIIIIIII',
           'YZZZZZYIIIII','XZZZZZXIIIII','YZZZZZZZYIII','XZZZZZZZXIII','YZZZZZZZZZYI','XZZZZZZZZZXI',
           'IIIIIIIIIIII','IIZIIIIIIIII','IIYZYIIIIIII','IIXZXIIIIIII','IIYZZZYIIIII','IIXZZZXIIIII',
           'IIYZZZZZYIII','IIXZZZZZXIII','IIYZZZZZZZYI','IIXZZZZZZZXI','IIIIIIIIIIII','IIIIZIIIIIII',
           'IIIIYZYIIIII','IIIIXZXIIIII','IIIIYZZZYIII','IIIIXZZZXIII','IIIIYZZZZZYI','IIIIXZZZZZXI',
           'IIIIIIIIIIII','IIIIIIZIIIII','IIIIIIYZYIII','IIIIIIXZXIII','IIIIIIYZZZYI','IIIIIIXZZZXI',
           'IIIIIIIIIIII','IIIIIIIIZIII','IIIIIIIIYZYI','IIIIIIIIXZXI','IIIIIIIIIIII','IIIIIIIIIIZI',
           'IIIIIIIIIIII','IZIIIIIIIIII','ZZIIIIIIIIII']
    ...
    for i,Pstr in enumerate(P_str):
        ...
        for j in range(qc_noise.qregs[0]._size):
            qc_noise.append(Noise_Model["Spam_error"],[qc_noise.qregs[0][j]])
    ...
    exp_vals.append(0.5-exp_val[0]/2)
    exp_vals.append(exp_val[1]/4+exp_val[2]/4)
    exp_vals.append(exp_val[3]/4+exp_val[4]/4)
    exp_vals.append(exp_val[5]/4+exp_val[6]/4)
    exp_vals.append(exp_val[7]/4+exp_val[8]/4)
    exp_vals.append(exp_val[9]/4+exp_val[10]/4)
    exp_vals.append(0.5-exp_val[11]/2)
    exp_vals.append(exp_val[12]/4+exp_val[13]/4)
    exp_vals.append(exp_val[14]/4+exp_val[15]/4)
    exp_vals.append(exp_val[16]/4+exp_val[17]/4)
    exp_vals.append(exp_val[17]/4+exp_val[18]/4)
    exp_vals.append(0.5-exp_val[19]/2)
    exp_vals.append(exp_val[20]/4+exp_val[21]/4)
    exp_vals.append(exp_val[22]/4+exp_val[23]/4)
    exp_vals.append(exp_val[24]/4+exp_val[25]/4)
    exp_vals.append(0.5-exp_val[26]/2)
    exp_vals.append(exp_val[27]/4+exp_val[28]/4)
    exp_vals.append(exp_val[29]/4+exp_val[30]/4)
    exp_vals.append(0.5-exp_val[31]/2)
    exp_vals.append(exp_val[32]/4+exp_val[33]/4)
    exp_vals.append(0.5-exp_val[34]/2)
    exp_vals.append(0.25-exp_val[-2]/4-exp_val[0]/4+exp_val[-1]/4)
    
    #exp_vals=[val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11]
    unenc[str(s)]=exp_vals
    
with open('Unenc_u_100_10.pickle', 'wb') as handle:
...
model = QiskitCircuitGeneratorAVQITE1(ansatz_filename='ansatz_inp_100.pkle', incar_filename='incar_12')
...
P_str=['IIIIIIIIIIIIII','IZIIIIIIIIIIIZ','IYZYIIIIIIIIIZ','IXZXIIIIIIIIIZ','IYZZZYIIIIIIIZ','IXZZZXIIIIIIIZ',
       'IYZZZZZYIIIIIZ','IXZZZZZXIIIIIZ','IYZZZZZZZYIIIZ','IXZZZZZZZXIIIZ','IYZZZZZZZZZYIZ','IXZZZZZZZZZXIZ',
       'IIIIIIIIIIIIII','IIIZIIIIIIIIIZ','IIIYZYIIIIIIIZ','IIIXZXIIIIIIIZ','IIIYZZZYIIIIIZ','IIIXZZZXIIIIIZ',
       'IIIYZZZZZYIIIZ','IIIXZZZZZXIIIZ','IIIYZZZZZZZYIZ','IIIXZZZZZZZXIZ','IIIIIIIIIIIIII','IIIIIZIIIIIIIZ',
       'IIIIIYZYIIIIIZ','IIIIIXZXIIIIIZ','IIIIIYZZZYIIIZ','IIIIIXZZZXIIIZ','IIIIIYZZZZZYIZ','IIIIIXZZZZZXIZ',
       'IIIIIIIIIIIIII','IIIIIIIZIIIIIZ','IIIIIIIYZYIIIZ','IIIIIIIXZXIIIZ','IIIIIIIYZZZYIZ','IIIIIIIXZZZXIZ',
       'IIIIIIIIIIIIII','IIIIIIIIIZIIIZ','IIIIIIIIIYZYIZ','IIIIIIIIIXZXIZ','IIIIIIIIIIIIII','IIIIIIIIIIIZIZ',
       'IIIIIIIIIIIIII','IIZIIIIIIIIIIZ','IZZIIIIIIIIIII']
...
with open('enc_val_3_1_u_100_10.pickle', 'wb') as handle:
    pickle.dump(enc_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
with open('enc_suc_3_1_u_100_10.pickle', 'wb') as handle:
    pickle.dump(pass_dict, handle, protocol=pickle.HIGHEST_PROTOCOL)
    
val_lst=[0.5,-0.5,0.25,0.25,0.25,0.25,0.25,0.25,0.25,0.25,0.25,0.25,0.5,-0.5,0.25,0.25,0.25,0.25,0.25,0.25
        ,0.25,0.25,0.5,-0.5,0.25,0.25,0.25,0.25,0.25,0.25,0.5,-0.5,0.25,0.25,0.25,0.25,0.5,-0.5,0.25,0.25
        ,0.5,-0.5,0.25,-0.25,-0.25,0.25]

P_str_lst=['IIIIIIIIIIII','ZIIIIIIIIIII','YZYIIIIIIIII','XZXIIIIIIIII','YZZZYIIIIIII','XZZZXIIIIIII',
           'YZZZZZYIIIII','XZZZZZXIIIII','YZZZZZZZYIII','XZZZZZZZXIII','YZZZZZZZZZYI','XZZZZZZZZZXI',
           'IIIIIIIIIIII','IIZIIIIIIIII','IIYZYIIIIIII','IIXZXIIIIIII','IIYZZZYIIIII','IIXZZZXIIIII',
           'IIYZZZZZYIII','IIXZZZZZXIII','IIYZZZZZZZYI','IIXZZZZZZZXI','IIIIIIIIIIII','IIIIZIIIIIII',
           'IIIIYZYIIIII','IIIIXZXIIIII','IIIIYZZZYIII','IIIIXZZZXIII','IIIIYZZZZZYI','IIIIXZZZZZXI',
           'IIIIIIIIIIII','IIIIIIZIIIII','IIIIIIYZYIII','IIIIIIXZXIII','IIIIIIYZZZYI','IIIIIIXZZZXI',
           'IIIIIIIIIIII','IIIIIIIIZIII','IIIIIIIIYZYI','IIIIIIIIXZXI','IIIIIIIIIIII','IIIIIIIIIIZI',
           'IIIIIIIIIIII','IZIIIIIIIIII','ZIIIIIIIIIII','ZZIIIIIIIIII']
exp_vals=[]
...
with open('EXT_expvals_u_100_m.npy', 'wb') as f:
